...
const TEMPLATE_TYPES = [
  {
    ...
    value: 1,
    label: 'Email',
    description: 'Responsive email templates with MJML',
    icon: Mail,
  ...
  },
  {
    ...
    value: 2,
    label: 'Facture',
    description: 'Invoice templates that generate PDF',
    icon: FileText,
  ...
  },
  {
    ...
    value: 3,
    label: 'Contrat',
    description: 'Contract templates that generate PDF',
    icon: ScrollText,
...
export default function NewTemplatePage() {
  ...
  return (
    <div className="max-w-2xl mx-auto py-8">
      ...
      >
        <h1 className="text-2xl font-bold text-slate-900 mb-1">Create Template</h1>
        <p className="text-slate-500 text-sm mb-8">Choose a type and give your template a name</p>

        {/* Type Selection */}
        <div className="mb-6">
          <Label className="text-sm font-medium mb-3 block">Template Type</Label>
